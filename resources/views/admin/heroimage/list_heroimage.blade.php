...
@section('content')
    ...
    @endforeach --}}
        ...
        <a href="{{ route('products.create') }}">Add New Hero image</a>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Add New Hero image</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Add New Hero image<small></small></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('herogallery.store') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="card-body">
                        ...
                        @foreach ($galleries as $gallery)
                            <tr>
                                ...
                                <td style="display: flex">
                                    ...
                                    <form action="{{ route('herogallery.destroy', $gallery->id) }}" method="post"
